...
module.exports.compressSync = function (input, params) {
  if (!Buffer.isBuffer(input)) {
...
module.exports.decompressSync = function (input, params) {
  if (!Buffer.isBuffer(input)) {
    throw new Error("Input is not a buffer.");
  }
...
TransformStreamCompressor.prototype._transform = function (
  chunk,
  encoding,
  next
) {
...
module.exports.compressStream = function (params) {
...
TransformStreamDecompressor.prototype._transform = function (
  chunk,
  encoding,
  next
) {
...
// We need to fill the blockSize for better compression results
function decompressStreamChunk(
  stream,
  chunk,
  decompressor,
  status,
...
module.exports.decompressStream = function (params) {
